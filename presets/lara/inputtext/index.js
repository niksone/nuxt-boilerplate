export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Invalid State
      {
        "border-red-500 dark:border-red-400 focus:ring-red-500/50 dark:focus:ring-red-400/50":
          props.invalid,
      },
      ...
      // States
      {
        ...
        "focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-500/50 dark:focus:ring-primary-400/50 focus:z-10":
          !context.disabled,
        "opacity-60 bg-surface-300 select-none pointer-events-none cursor-default":
          context.disabled,
      },
