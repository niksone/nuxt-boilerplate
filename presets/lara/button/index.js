export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      "leading-[normal]",
      {
        "text-sm py-2 px-3": props.size === "small" && !props.icon,
        ["px-4 py-3"]: props.size === null && !props.icon,
        "text-xl py-3 px-4": props.size === "large" && !props.icon,

        "w-8 h-8": props.size === "small" && props.icon,
        "w-10 h-10": props.size === null && props.icon,
        "w-12 h-12": props.size === "large" && props.icon,
      },
      // {
      ...
      // Primary
      {
        "hover:bg-primary-600 dark:hover:bg-primary-400 hover:border-primary-600 dark:hover:border-primary-300":
          !props.link &&
          props.severity === null &&
          !props.text &&
          !props.outlined &&
